...
#include "..\3rdparty\include\sqlite3\sqlite3.h"

#include "CppSQLiteLib.h"
#include <cstdio>
#include <cstring>
...
namespace detail
{
    ...
    */
    class CPPSQLITELIB_EXPORT SQLite3Memory
    {
    public:
...
class CPPSQLITELIB_EXPORT CppSQLite3Exception
{
public:
...
class CPPSQLITELIB_EXPORT CppSQLite3Buffer
{
public:
...
class CPPSQLITELIB_EXPORT CppSQLite3Binary
{
public:
...
class CPPSQLITELIB_EXPORT CppSQLite3Query
{
public:
...
class CPPSQLITELIB_EXPORT CppSQLite3Table
{
public:
...
class CPPSQLITELIB_EXPORT CppSQLite3Statement
{
public:
...
class CPPSQLITELIB_EXPORT CppSQLite3DB
{
public:
